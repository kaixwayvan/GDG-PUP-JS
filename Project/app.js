...
// * removed the let - cannot redeclare variables
userChoice = userChoiceDisplay; // Store the user's choice
...
function playGame() {
    ...
    if (!resultDisplay) {
        console.error("Error! Check HTML");
        return;
    }
...
function resetGame() {
    ...
    computerChoiceDisplay.innerHTML = '<img src="./assets/images/icon-computer.png" alt="user" class="choice--img">';
