...
// Using let
let name = "Daniel"; // Define a string here, e.g., "Juan Cruz"
let age = 19; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ["badminton", "moviegoer", "singing"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
const birthYear = 2080; // Define a number here, e.g., 1990
const isEmployed = false; // Define a boolean here, e.g., true or false
const favoriteBooks = ["The Hunger Games", "Ikigai: The Japanese Secret to a Long and Happy Life", "Atomic Habits"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
var temperature = 26.11; // Define a number here, e.g., 22.5
var hasPets = true; // Define a boolean here, e.g., true or false
var colors = ["Rosewood", "Light coral", "Salmon"]; // Define an array here, e.g., ["red", "green", "blue"]
